...
import 'package:bilet_cep/screens/admin/airplane/airplanes.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:flutter/material.dart';
import 'package:bilet_cep/Responsive.dart';
import 'package:bilet_cep/main.dart';
import 'package:bilet_cep/model/menu_modal.dart';
...
class _MenuState extends State<Menu> {
  List<MenuModel> menu = [
    ...
    MenuModel(icon: 'assets/svg/remote.svg', title: "Hava Alanları"),
                  ...
                  onTap: () {
                    ...
                    switch (i) {
                      ...
                      case 1: // Controller
                        Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: (context) => const AirplanesPage()),
                        );
                        break;
